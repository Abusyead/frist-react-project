function HeroArea() {
  return (
    <section className="bg-[url(/img/heroarea.png)] bg-cover bg-center h-[80vh]">
        <div className="flex justify-center sm:items-start items-center   flex-col text-white w-full h-full max-w-[1440px] mx-auto px-4">
            ...
            <button className="btnColor mt-6 px-5 py-2 mx-5 sm:mx-0 rounded-full text-black text-sm w-full sm:w-auto">Sign Up for the Beta</button>
        </div>
    </section>
  )
}
